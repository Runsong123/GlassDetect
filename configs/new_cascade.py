...
data = dict(
    imgs_per_gpu=4, # 有的同学不知道batchsize在哪修改，其实就是修改这里，每个gpu同时处理的images数目。
    workers_per_gpu=2,
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations_washed.json', # 更换自己的json文件
...
log_level = 'INFO'
work_dir = '/home/culturerelics/mmdetection/work_dirs/cascade_rcnn_clean' # 日志目录
